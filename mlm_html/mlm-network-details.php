		  ...
		  <tr>
			<td width="40%" valign="top">
				<table width="100%" border="0" cellspacing="10" cellpadding="1">
				  ...
				  <tr>
		<td><a href="<?= get_post_id_or_postname('mlm_update_profile_page','binary-mlm-pro');?>" style="text-decoration: none"><?php _e('Edit','binary-mlm-pro');?></a></td>
		<td><a href="<?= get_post_id_or_postname('mlm_network_genealogy_page','binary-mlm-pro');?>" style="text-decoration: none"><?php _e('View Genealogy','binary-mlm-pro');?></a></td>
		</tr>
				</table>
					<table width="100%" border="0" cellspacing="10" cellpadding="1">
				  <tr>
...
$mlm_settings = get_option('wp_mlm_general_settings');
	?>
		...
		<tr>
			...
			<td><a href="<?=get_post_id_or_postname_for_payout('mlm_my_payout_details_page', $row->payout_id)?>"><?= __('View','binary-mlm-pro');?></a></td>
	...
	?>
				   ...
				   <tr>
					<td>
						<table width="100%" border="0" cellspacing="10" cellpadding="1">
							...
							<tr>
								<td><?php _e('Total on Left Leg','binary-mlm-pro');?>: <?=$leftLegUsers ?></td>
								<td><?php _e('Active','binary-mlm-pro');?>: <?= $leftLegActiveUsers?></td>
							</tr>
							<?php
		...
		?>
							<tr>
		<td colspan="2"><a href="<?= get_post_id_or_postname('mlm_left_group_details_page','binary-mlm-pro');?>" style="text-decoration: none"><?php _e('View All','binary-mlm-pro');?></a></td>
		</tr>
			...
			<tr>
					<td>
						<table width="100%" border="0" cellspacing="10" cellpadding="1">
							...
							<tr>
								<td><?php _e('Total on Right Leg','binary-mlm-pro');?>: <?= $rightLegUsers?></td>
			<td><?php _e('Active','binary-mlm-pro');?>: <?= $rightLegActiveUsers?></td>
							</tr>
							<?php
		...
		?>
							<tr>
		<td colspan="2"><a href="<?= get_post_id_or_postname('mlm_right_group_details_page','binary-mlm-pro');?>" style="text-decoration: none"><?php _e('View All','binary-mlm-pro');?></a></td>
		</tr>
					...
					<td>
						<table width="100%" border="0" cellspacing="10" cellpadding="1">
							...
							<tr>
								<td><?php _e('My Personal Sales','binary-mlm-pro');?>: <?= $personalSales?></td>
			<td><?php _e('Active','binary-mlm-pro');?>: <?= $activePersonalSales?></td>
							</tr>
							<?php
		...
		?>
							<tr>
		<td colspan="2"><a href="<?= get_post_id_or_postname('mlm_personal_group_details_page','binary-mlm-pro');?>" style="text-decoration: none"><?php _e('View All','binary-mlm-pro');?></a></td>
		</tr>
