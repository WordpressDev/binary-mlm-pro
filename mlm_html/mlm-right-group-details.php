...
function drawVisualization() {
  ...
  {cols:[
	...
	{id:'D',label:'<?= _e("Status","binary-mlm-pro"); ?>',type:'string'}],
  rows:[
			...
			<div class="va-admin-leg-details">
				...
				<div class="paging">
				  <form action="">
					...
					<?php _e('Total Users','binary-mlm-pro');?>: <strong><?= $rightLegUsers; ?></strong>&nbsp;<?php _e('Active Users','binary-mlm-pro');?>: <strong><?= $rightLegActiveUsers; ?></strong>
					</div>
