...
<tr>
	...
	<td><?= $mlm_settings['currency'].' ';?><?= (!empty($summaryArr['total_amount']))?$summaryArr['total_amount']:'0'; ?></td>
</tr>
<tr>
	<td><?php _e('Pending Payments','binary-mlm-pro');?></td>
	<td><?= $mlm_settings['currency'].' ';?><?= (!empty($summaryArr['pending_amount']))?$summaryArr['pending_amount']:'0'; ?></td>
</tr>
<tr>
	<td><?php _e('Processed Payments','binary-mlm-pro');?></td>
	<td><?= $mlm_settings['currency'].' ';?><?= (!empty($summaryArr['processed_amount']))?$summaryArr['processed_amount']:'0'; ?></td>
</tr>
<tr>
	<td><?php _e('Available Amount','binary-mlm-pro');?></td>
	<td><?= $mlm_settings['currency'].' ';?><?= (!empty($summaryArr['available_amount']))?$summaryArr['available_amount']:'0'; ?></td>
</tr>
