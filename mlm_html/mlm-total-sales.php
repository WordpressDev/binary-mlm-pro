...
function drawVisualization() {
  ...
  var dataAsJson =
  {cols:[
  	{id:'A',label:'<?= _e("User Name","binary-mlm-pro"); ?>',type:'string'},
	{id:'B',label:'<?= _e("User Key","binary-mlm-pro"); ?> ',type:'string'},
	{id:'C',label:'<?= _e("Sponsor","binary-mlm-pro"); ?>',type:'string'},
	{id:'D',label:'<?= _e("Placement","binary-mlm-pro"); ?>',type:'string'},
	{id:'E',label:'<?= _e("Status","binary-mlm-pro"); ?>',type:'string'}],
  rows:[
			...
			<div class="va-admin-leg-details">
				...
				<div class="paging">
				  <form action="">
					...
					<?php _e('Consultants','binary-mlm-pro');?>: &nbsp; <?php _e('Left','binary-mlm-pro');?>: <strong><?= $leftLegUsers; ?></strong>&nbsp;<?php _e('Right','binary-mlm-pro');?>: <strong><?= $rightLegUsers; ?></strong>
					&nbsp; <?php _e('Total','binary-mlm-pro');?>: <strong><?= $totalConsultant;?></strong>
					</div>
