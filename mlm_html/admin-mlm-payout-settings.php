            ...
            <form name="admin_payout_settings" method="post" action="">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="pair1" id="pair1" size="2" value="<?= $pair1 ?>"> : 
                            <input type="text" name="pair2" id="pair2" size="2" value="<?= $pair2 ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="initial_pair" id="initial_pair" size="2" value="<?= $initial_pair ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="initial_amount" id="initial_amount" size="10" value="<?= $initial_amount ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="further_amount" id="further_amount" size="10" value="<?= $further_amount ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="referral_commission_amount" id="referral_commission_amount" size="10" value="<?= $referral_commission_amount ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="service_charge" id="service_charge" size="10" value="<?= $service_charge ?>">
                            <select name="service_charge_type" id="service_charge_type" >
                                <option value="">Select type</option>
                                <option value="Fixed" <?= $service_charge_type == 'Fixed' ? 'selected="selected"' : '' ?>>Fixed</option>
                                <option value="Percentage" <?= $service_charge_type == 'Percentage' ? 'selected="selected"' : '' ?>>Percentage</option>
                            </select> 
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="tds" id="tds" size="10" value="<?= $tds ?>">&nbsp;%
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="cap_limit_amount" id="cap_limit_amount" size="10" value="<?= $cap_limit_amount ?>">
