    ...
    if ($chk != '') {
        ...
        <div class='wrap1'>
            ...
            <div class="notibar msginfo">
                ...
                <p><strong><?php _e('Service Charges', 'binary-mlm-pro'); ?> - </strong> <?php _e('An amount that is deducted from each Payout paid to the member as a fixed or Percent base Service Charge. eg. $2 or $0.02 as processing fee for each payout.', 'binary-mlm-pro'); ?></p>
                ...
                <form name="admin_payout_settings" method="post" action="">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="form-table">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="pair1" id="pair1" size="2" value="<?php if (isset($_POST['pair1'])) _e(htmlentities($_POST['pair1'])); ?>"> : 
                                <input type="text" name="pair2" id="pair2" size="2" value="<?php if (isset($_POST['pair2'])) _e(htmlentities($_POST['pair2'])); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="initial_pair" id="initial_pair" size="2" value="<?php if (isset($_POST['initial_pair'])) _e(htmlentities($_POST['initial_pair'])); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="initial_amount" id="initial_amount" size="10" value="<?php if (isset($_POST['initial_amount'])) _e(htmlentities($_POST['initial_amount'])); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="further_amount" id="further_amount" size="10" value="<?php if (isset($_POST['further_amount'])) _e(htmlentities($_POST['further_amount'])); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="referral_commission_amount" id="referral_commission_amount" size="10" value="<?php if (isset($_POST['referral_commission_amount'])) _e($_POST['referral_commission_amount']); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="service_charge" id="service_charge" size="10" value="<?php if (isset($_POST['service_charge'])) _e(htmlentities($_POST['service_charge'])); ?>">
                                <select name="service_charge_type" id="service_charge_type" >
                                    <option value="">Select service charge deduct  type</option>
                                    <option value="Fixed" <?= isset($_POST['service_charge_type']) && $_POST['service_charge_type'] == 'Fixed' ? 'selected="selected"' : '' ?>>Fixed</option>
                                    <option value="Percentage" <?= isset($_POST['service_charge_type']) && $_POST['service_charge_type'] == 'Percentage' ? 'selected="selected"' : '' ?>>Percentage</option>
                                </select> 
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tds" id="tds" size="10" value="<?php if (isset($_POST['tds'])) _e(htmlentities($_POST['tds'])); ?>">&nbsp;%
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="cap_limit_amount" id="cap_limit_amount" size="10" value="<?php if (isset($mlm_settings['cap_limit_amount'])) _e($mlm_settings['cap_limit_amount']); ?>">
                ...
                <form name="admin_payout_settings" method="post" action="">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="form-table">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="pair1" id="pair1" size="2" value="<?php if (isset($mlm_settings['pair1'])) _e($mlm_settings['pair1']); ?>"> : 
                                <input type="text" name="pair2" id="pair2" size="2" value="<?php if (isset($mlm_settings['pair2'])) _e($mlm_settings['pair2']); ?>">
                                <div class="toggle-visibility" id="admin-mlm-pair"><?php _e('Please mention here pair ratio.', 'binary-mlm-pro'); ?></div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="initial_pair" id="initial_pair" size="2" value="<?php if (isset($mlm_settings['initial_pair'])) _e($mlm_settings['initial_pair']); ?>">
                                <div class="toggle-visibility" id="admin-mlm-initial-pair"><?php _e('Please mention here initial pair.', 'binary-mlm-pro'); ?></div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="initial_amount" id="initial_amount" size="10" value="<?php if (isset($mlm_settings['initial_amount'])) _e($mlm_settings['initial_amount']); ?>">
                                <div class="toggle-visibility" id="admin-mlm-initial-amount"><?php _e('Please mention here initial amount.', 'binary-mlm-pro'); ?></div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="further_amount" id="further_amount" size="10" value="<?php if (isset($mlm_settings['further_amount'])) _e($mlm_settings['further_amount']); ?>">
                                <div class="toggle-visibility" id="admin-mlm-further-amount"><?php _e('Please mention here further pair amount.', 'binary-mlm-pro'); ?></div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="referral_commission_amount" id="referral_commission_amount" size="10" value="<?php if (isset($mlm_settings['referral_commission_amount'])) _e($mlm_settings['referral_commission_amount']); ?>">
                                <div class="toggle-visibility" id="admin-mlm-direct-referal-commission"><?php _e('Please specify referral_commission_amount.', 'binary-mlm-pro'); ?></div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="service_charge" id="service_charge" size="10" value="<?php if (isset($mlm_settings['service_charge'])) _e($mlm_settings['service_charge']); ?>">
                                <select name="service_charge_type" id="service_charge_type" >
                                    <option value="">Select type</option>
                                    <option value="Fixed" <?= isset($mlm_settings['service_charge_type']) && $mlm_settings['service_charge_type'] == 'Fixed' ? 'selected="selected"' : '' ?>>Fixed</option>
                                    <option value="Percentage" <?= isset($mlm_settings['service_charge_type']) && $mlm_settings['service_charge_type'] == 'Percentage' ? 'selected="selected"' : '' ?>>Percentage</option>
                                </select> 
                                <div class="toggle-visibility" id="admin-mlm-service-charege"><?php _e('Please specify service charge.', 'binary-mlm-pro'); ?></div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tds" id="tds" size="10" value="<?php if (isset($mlm_settings['tds'])) _e($mlm_settings['tds']); ?>">&nbsp;%
                                <div class="toggle-visibility" id="admin-mlm-tds"><?php _e('Please specify TDS.', 'binary-mlm-pro'); ?></div>
                            </td>
                        </tr>
                        <tr>
