...
<?php	
	...
	if(!empty($_POST['cheque_no']))$cheque_no= $_POST['cheque_no']; else $cheque_no = '';
	if(!empty($_POST['cheque_date']))$cheque_date= $_POST['cheque_date']; else $cheque_date = '';
	if(!empty($_POST['cbank_name']))$bank_name= $_POST['cbank_name'];  else $bank_name = '';

	if(!empty($_POST['btbank_name'])) $user_bank_name= $_POST['btbank_name']; else $user_bank_name = '';
	if(!empty($_POST['btaccount_no']))$user_bank_account_no= $_POST['btaccount_no']; else $user_bank_account_no = '';
	if(!empty($_POST['bt_code']))$banktransfer_code= $_POST['bt_code']; else $banktransfer_code = '';
	if(!empty($_POST['bt_benificiary']))$beneficiary= $_POST['bt_benificiary']; else $beneficiary = '';
	if(!empty($_POST['pmode']))$payment_mode= $_POST['pmode']; else $payment_mode = '';
	if(!empty($_POST['specified']))$comment= $_POST['specified']; else $comment = '';
