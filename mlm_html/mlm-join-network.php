...
<form name="frm" method="post" action="" onSubmit="checkspname()">			
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><?= __('Left', 'binary-mlm-pro') ?> <input id="left" type="radio" name="leg" value="0" <?= (isset($led) && $leg=='0')?'checked="checked"':''; ?> />
                        <?= __('Right', 'binary-mlm-pro') ?><input id="right" type="radio" name="leg" value="1" <?= (isset($led) && $leg=='0')?'checked="checked"':''; ?>/>
                    </td>
