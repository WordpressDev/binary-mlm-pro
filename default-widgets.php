        ...
        if (is_user_logged_in())
        {
            ...
            <div class="join_box">
                ...
                <div class="join_box_right">
                    ...
                    ?>
                    <a class="subscribe button-primary1" href="<?= get_post_id_or_postname('mlm_registration_page', 'binary-mlm-pro'); ?>/">Join Now</a>
                </div>
            </div>
            <?php
        }
            ...
            if (!empty($sp_name))
            {
                ...
                <?php echo get_avatar($userid, 80); ?>
                    ...
                    <div class="join_box_right">
                        ...
                        ?>
                        <a class="subscribe button-primary1" href="<?= get_post_id_or_postname('mlm_registration_page', 'binary-mlm-pro'); ?><?= empty($concat) ? '/?' : $concat ?>sp_name=<?= $sp_name; ?>">Join Now</a>
                    </div>
                </div>
                <?php
            }
